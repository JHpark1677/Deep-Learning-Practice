...
class Attention(nn.Module):
  ...
  def forward(self, x):
    ...
    # query's shape : [2, 65, 128]

    ## embedding size 128을 head 갯수 * head dimension으로 나누어준다.
    ...
    # [2, 8, 65, 65] x [2, 8, 65, 16]
    # attn's shape : [2, 65, 8, 16]
